...
Apres un 3eme commit on s'est rendu compte qu'on ne doit pas passer notre identifiant et le mdp sur internet alors on doit supprimer ce fichier credential a l'aide de la commande git rm
